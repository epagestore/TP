...
$compare_chart=array();
$compare_chart[]=array("Order"=>"Number of paid orders", "Number"=>$total_paid->number);
$compare_chart[]=array("Order"=>"Number of received orders", "Number"=>$total_received->number);
?>
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Order <small>statistics & reports</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
			...
			<div class="row margin-top-10">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-red-haze">
								    <?php echo $currency_symbol;?>
									<span data-value="<?php echo number_format(sprintf("%.2f", ($total_order_sent_amount)*$value),2); ?>" data-counter="counterup"><?php echo sprintf("%.2f", ($total_order_sent_amount)*$value); ?></span>
								</h3>
						...
						<div class="progress-info">
							<div class="progress">
								<span style="width: <?php echo $total_transaction_amount?(int)(($total_order_sent_amount/$total_transaction_amount)*100):"0"; ?>%;" class="progress-bar progress-bar-success red-haze">
								<span class="sr-only"><?php echo ($total_order_sent_amount); ?> <?php echo $total_transaction_amount?(int)(($total_order_sent_amount/$total_transaction_amount)*100):"0"; ?>% </span>
								</span>
							</div>
							<div class="status">
								<div class="status-title">
								...
								<div class="status-number">
									 <?php echo $total_transaction_amount?(int)(($total_order_sent_amount/$total_transaction_amount)*100):0; ?>%
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-purple-soft" data-value="<?php echo $total_order_received; ?>" data-counter="counterup"><?php echo $total_order_received; ?></h3>
								<small>No of orders receieved </small>
							</div>
							<div class="icon">
								<i class="icon-user"></i>
							</div>
						...
						<div class="progress-info">
							<div class="progress">
								<span style="width: <?php echo $total_order?(int)(($total_order_received/$total_order)*100):0; ?>%;" class="progress-bar progress-bar-success purple-soft">
								<span class="sr-only"><?php echo $total_order?(int)(($total_order_received/$total_order)*100):0; ?>% </span>
								</span>
							</div>
							<div class="status">
								<div class="status-title">
								...
								<div class="status-number">
									 <?php echo $total_order?(int)(($total_order_received/$total_order)*100):0; ?>%
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-red-haze"  data-value="<?php echo $total_order_sent1; ?>" data-counter="counterup"><?php echo $total_order_sent1; ?></h3>
								<small>No of orders made</small>
							</div>
							<div class="icon">
								<i class="icon-like"></i>
							</div>
						...
						<div class="progress-info">
							<div class="progress">
								<span style="width: <?php echo $total_order?(int)(($total_order_sent1/$total_order)*100):0; ?>%;" class="progress-bar progress-bar-success red-haze">
								<span class="sr-only"><?php echo ($total_order_sent1); ?><?php echo $total_order?(int)(($total_order_sent1/$total_order)*100):0; ?>% </span>
								</span>
							</div>
							<div class="status">
								<div class="status-title">
								...
								<div class="status-number">
									 <?php echo $total_order?(int)(($total_order_sent1/$total_order)*100):0; ?>%
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-blue-sharp">
								    <?php echo $currency_symbol;?>
									<span data-value="<?php echo number_format(sprintf("%.2f", ($total_order_received_amount)*$value),2); ?>" data-counter="counterup"><?php echo sprintf("%.2f", ($total_order_received_amount)*$value); ?></span>
								</h3>
								<small>Total received orders</small>
							</div>
							<div class="icon">
						...
						<div class="progress-info">
							<div class="progress">
								<span style="width:  <?php echo $total_transaction_amount?(int)(($total_order_received_amount/$total_transaction_amount)*100):0; ?>%;" class="progress-bar progress-bar-success blue-sharp">
								<span class="sr-only">  <?php echo $total_transaction_amount?(int)(($total_order_received_amount/$total_transaction_amount)*100):0; ?>% </span>
								</span>
							</div>
							<div class="status">
								<div class="status-title">
								...
								<div class="status-number">
									   <?php echo $total_transaction_amount?(int)(($total_order_received_amount/$total_transaction_amount)*100):0; ?>%
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-red-haze" data-value="<?php echo $total_order; ?>" data-counter="counterup"><?php echo $total_order; ?></h3>
				...
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject bold uppercase font-dark">Total orders</span>
				...
				<div class="portlet-title">
						<div class="caption">
							<span class="caption-subject bold uppercase font-dark">Total paid orders</span>
							<span class="caption-helper"></span>
						</div>					   
					 </div>
				<div class="col-md-12 portlet-body portlet light bordered">
					
					<div  id="order_paid_amount" class="CSSAnimationChart"></div>
				</div>
				<div class="portlet-title">
						<div class="caption">
							<span class="caption-subject bold uppercase font-dark">Total received orders</span>
							<span class="caption-helper"></span>
						</div>					   
					 </div>
				<div class="col-md-12 portlet-body portlet light bordered">
					
					<div  id="order_milestone_amount" class="CSSAnimationChart"></div>
				</div>
				<div class="portlet-title">
						<div class="caption">
							<span class="caption-subject bold uppercase font-dark">No of orders paid </span>
							<span class="caption-helper"></span>
						</div>					   
					 </div>
				<div class="col-md-12 portlet-body portlet light bordered">
					
					<div  id="t_d_o_p_n" class="CSSAnimationChart"></div>
				</div>
				<div class="portlet-title">
						<div class="caption">
							<span class="caption-subject bold uppercase font-dark">No of orders received </span>
							<span class="caption-helper"></span>
						</div>					   
					 </div>
				<div class="col-md-12 portlet-body portlet light bordered">
					
					<div  id="t_d_o_m_n" class="CSSAnimationChart"></div>
				</div>
				<div class="portlet-title">
						<div class="caption">
							<span class="caption-subject bold uppercase font-dark">Total number of transactions</span>
							<span class="caption-helper"></span>
						</div>					   
					 </div>
				<div class="col-md-12 portlet-body portlet light bordered">
					
					<div  id="order_total_transection" class="CSSAnimationChart"></div>
				</div>
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject bold uppercase font-dark">Order Compare Chart</span>
						<span class="caption-helper"></span>
					</div>					   
				 </div>
				<div class="col-md-12 portlet-body portlet light bordered">
