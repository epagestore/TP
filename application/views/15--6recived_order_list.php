					...
					//	$(".collapse.in").removeClass('in out');
						...
						{	
							...
							}else if(element['remedy']=='Replacement')
							{
								...
								table=table+'<br/><small>Amount Refunded (Discount <span class="text-danger">'+(((((parseFloat(element['product_main_amount'])*parseFloat($c_value))-(parseFloat(element['paid_amount'])*parseFloat($c_value)).toFixed(2))/(parseFloat(element['product_main_amount'])*parseFloat($c_value)))*100).toFixed(2))+'%</span>)';
							}
						}
						...
						if(commission>0)
						table=table+"<br/><small>Commissions paid <span class='text-danger'>"+(element['company_url']==null?'':"("+element['company_url']+")")+"</span></small><br/>";
						table=table+"</td>";
						table=table+"<td colspan='2'>";
						...
						if(commission>0)
						table=table+"<br/><small class='text-danger'><?php echo $currency_symbol;?>"+commission+"</small><br/>";
						table=table+"</td>";
						table=table+"</tr>";
