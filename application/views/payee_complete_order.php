		...
		<form class="form-horizontal" method="post" action="">
		 <tbody>
			...
			<?php if($this->session->userdata('customer_id') && $cust_login){?>
			  <tr>
				<td  class="text-left">Payer</td>
				<td class="text-right"><?php echo $payer_name;?></td>
			  </tr>
			  <tr>
				<td  class="text-left">Payee Secret Key</td>
				<?php if(isset($customer_type)&&$customer_type=='payee'){?>
				<td class="text-right"><input type="<?php echo isset( $m_payee_key)? 'hidden':'text';?>" class="form-control" name="payee_key" id="payee_key" value="<?php echo isset( $m_payee_key)? $m_payee_key:'';?>" /><strong><?php echo isset( $m_payee_key)? $m_payee_key:'';?></strong> </td>
				<?php }else{?>
